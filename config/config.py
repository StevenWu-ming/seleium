...
class Config:
    ...
    class TestEnv:
        class MerchantBase:
            ...
            # 驗證碼與金額
            VERIFY_CODE = "123456" # 測試用驗證碼 已經可以不用了我直接從後台抓取驗證碼
            DP_Amount = '100' # 測試用存款金額/
            WD_Amount = '10' # 測試用提款金額
        ...
        class Merchant1(MerchantBase):
            ...
            SB_URL = "https://uat-newplatform.mxsyl.com/zh-cn/play/SaBaSport-1/All"  # 體育頁面網址

            PHONE_NUMBER = "13100000021" # 測試用手機號 cooper007
            PHONE_OTP = "+8613100******" # +86 測試用手機號碼（前五碼後面*）
            EMAIL = "hrtqdwmk@sharklasers.com" # 測試用電子郵件 cooper005
    ...
    class ProdEnv:
        ...
        class Merchant1(MerchantBase):
            ...
            PHONE_OTP = "+8618700******" # +86 測試用手機號碼（前五碼後面*）
